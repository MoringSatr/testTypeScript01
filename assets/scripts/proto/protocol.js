...
$root.DogProto = function () {
    ...
    DogProto.Dog = function () {
        ...
        Dog.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.DogProto.Dog();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        Dog.fromObject = function fromObject(object) {
            if (object instanceof $root.DogProto.Dog)
                return object;
...
$root.MessageProto = function () {
    ...
    MessageProto.Message = function () {
        ...
        Message.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.MessageProto.Message();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        Message.fromObject = function fromObject(object) {
            if (object instanceof $root.MessageProto.Message)
                return object;
    ...
    MessageProto.Text = function () {
        ...
        Text.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.MessageProto.Text();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        Text.fromObject = function fromObject(object) {
            if (object instanceof $root.MessageProto.Text)
                return object;
